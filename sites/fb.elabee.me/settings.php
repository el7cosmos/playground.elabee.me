...
$databases = array (
  'default' => array (
    'default' => array (
      ...
      'unix_socket' => $src['OPENSHIFT_MYSQL_DB_SOCKET'],
      'driver'      => 'mysql',
      'prefix'      => '',
    ),
  ),
...
$conf['file_private_path'] = $src['OPENSHIFT_DATA_DIR'] . 'sites/fb.elabee.me/files/private';
$conf['file_public_path']  = $src['OPENSHIFT_DATA_DIR'] . 'sites/fb.elabee.me/files/public';
